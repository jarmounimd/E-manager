        ...
        <div class="pd-ltr-20">
            <div class="card-box pd-20 height-100-p mb-30">
                <div class="row align-items-center">
                    <div class="col-md-4">
                        <img src="<?=ASSETS?>wallchef.png" alt="" />
                    </div>
                    <div class="col-md-8">
                        ...
                        <p class="font-18 max-width-600">
                            Bienvenue dans votre espace dédié à l'ENSAH ! <br>
                            En tant que chef de département, gérez les modules et les professeurs de votre département, attribuez les modules, modifiez les affectations, et consultez les notes.<br>
                            Vous pouvez aussi gérer les emplois du temps et assurer un archivage sécurisé des données.<br>
                            N'hésitez pas à nous contacter pour toute question ou suggestion. Bienvenue et bonne gestion !
                        </p>
