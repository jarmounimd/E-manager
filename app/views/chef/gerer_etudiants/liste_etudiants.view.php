...
<div class="main-container">
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            ...
            <?php
            // Instanciation de la classe Etudiants
            $etudiants = new etudiant;
            // Récupération de tous les étudiants avec leurs informations
            $allStudents = $etudiants->getAllStudents($_SESSION['user']->id_departement);

            // Organisation des étudiants par filière
            $filieres = [];
            foreach ($allStudents as $student) {
                $filieres[$student->id_filiere]['nom_filiere'] = $student->nom_filiere;
                $filieres[$student->id_filiere]['etudiants'][] = $student;
            }
            ?>
                    ...
                    <div class="pd-20 card-box mb-30">
                        <div class="table-responsive">
                            <div class="pd-20 card-box mb-30 text-center card-filiere">
                                ...
                                <div class="card-body">
                                    <?php if (!empty($filiere['etudiants']) && $filiere['etudiants'][0]->id !== NULL): ?>
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                            <?php foreach ($filiere['etudiants'] as $index => $etudiant): ?>
                                                <tr>
                                                    <th scope="row"><?= $index + 1; ?></th>
                                                    <td><?php echo $etudiant->nom; ?></td>
                                                    <td><?php echo $etudiant->prenom; ?></td>
                                                    <td><?php echo $etudiant->email; ?></td>
                                                    <td><a href="supprimer_etudiant?id=<?= $etudiant->id ?>" class="btn btn-danger"><span>Supprimer</span><i class="icon-copy bi bi-trash-fill"></i></a></td>
                                                </tr>
                                            <?php endforeach; ?>
                                            </tbody>
                                        </table>
                                    <?php else: ?>
                                        <p>Aucun étudiant disponible pour cette filière.</p>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
