            ...
            <ul id="accordion-menu">
                ...
                <li class="dropdown">
                    ...
                    <ul class="submenu">
                        ...
                        <li><a href="ajouter_module">Ajouter un étudiant</a></li>
                    </ul>
                </li>
    ...
    <div class="pd-20 card-box mb-30">
        <div class="clearfix">
            <div class="pull-left">
                ...
                <p class="mb-30">Entrer les détails de professeur ci-dessous :</p>
            </div>
        </div>
        ...
        <form method="POST" action="ajouter_prof/store">
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <select class="custom-select2 form-control" name="filiere" style="width: 100%; height: 38px">
                        <?php foreach ($filieres as $filiere): ?>
                            <option value="<?= $filiere->filiere_id ?>"><?= $filiere->nom_filiere ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
            </div>
            <!-- Add a hidden input field to capture the user's department ID -->
            <input type="hidden" name="id_departement" value="<?= $_SESSION['user']->id_departement ?>">
