...
<div class="main-container">
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            ...
            $allStudents = $etudiants->getStudentsWithFiliere($_SESSION['user']->id_filiere);

            // Vérification s'il y a des étudiants à afficher
...
?>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover">
                                    ...
                                    <?php foreach ($allStudents as $student): ?>
                                        <tr>
                                            <td><?php echo $student->nom_etudiant; ?></td>
                                            <td><?php echo $student->prenom_etudiant; ?></td>
                                            <td><?php echo $student->email_etudiant; ?></td>
                                        </tr>
                                    <?php endforeach; ?>
                                    </tbody>
                                </table>
            ...
            <?php
                ...
                echo "<p>Aucun étudiant disponible pour cette filière.</p>";
            }
            ?>
