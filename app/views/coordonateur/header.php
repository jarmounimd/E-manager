                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <div class="notification-list mx-h-350 customscroll">
                        <ul>
                            ...
                            $openTasks = $tacheModel->getTasksForCoor($_SESSION['user']->id);
                            $coor = new coordonateur();
                            $datas = $coor->getProfileCoor($_SESSION['user']->id);
        ...
        <div class="user-info-dropdown">
            <div class="dropdown">
                ...
                >
                        ...
                        <img src="<?= !empty($datas[0]->profile_pic) ? ASSETS . 'uploads/' . htmlspecialchars($datas[0]->profile_pic) : ASSETS . 'vendors/images/user_coordonateur.svg' ?>" alt="" />
                        </span>
                ...
                >
                    <a class="dropdown-item" href="profile_coor"
