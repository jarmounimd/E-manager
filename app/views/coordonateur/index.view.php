        ...
        <div class="pd-ltr-20">
            <div class="card-box pd-20 height-100-p mb-30">
                <div class="row align-items-center">
                    <div class="col-md-4">
                        <img src="<?=ASSETS?>wallcoor.png" alt="" />
                    </div>
                    <div class="col-md-8">
                        <h4 class="font-20 weight-500 mb-10 text-capitalize">
                            Welcome back
                            <div class="weight-600 font-30" style="color: #0073ca;" ><?=$data['prenom'];?></div>
                        </h4>
                        <p class="font-18 max-width-600">
                        En tant que coordonateur, vous avez accès à une gestion centralisée et efficace de vos tâches académiques. Gérez les modules, les professeurs et les étudiants de manière fluide. Attribuez les cours, modifiez les affectations, et suivez les performances académiques. Vous pouvez également organiser les emplois du temps et garantir une gestion sécurisée des données..<br>
                        Pour toute question ou suggestion, n'hésitez pas à nous contacter. Nous sommes là pour vous aider à optimiser votre gestion académique. Bienvenue et bonne gestion !
                        </p>
