        ...
        <div class="pd-ltr-20">
            <div class="card-box pd-20 height-100-p mb-30">
                <div class="row align-items-center">
                    <div class="col-md-4">
                        <img src="<?=ASSETS?>wallstud.png" alt="" />
                    </div>
                    <div class="col-md-8">
                        ...
                        <p class="font-18 max-width-600">
                            ...
                            Explorez facilement vos notes, votre emploi du temps, et bien plus encore. Notre plateforme est conçue pour simplifier votre parcours académique.<br>
