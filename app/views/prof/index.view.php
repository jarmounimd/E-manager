        ...
        <div class="pd-ltr-20">
            <div class="card-box pd-20 height-100-p mb-30">
                <div class="row align-items-center">
                    <div class="col-md-4">
                        <img src="<?=ASSETS?>wallprof.png" alt="" />
                    </div>
                    <div class="col-md-8">
                        <h4 class="font-20 weight-500 mb-10 text-capitalize">
                            Welcome back
                            <div class="weight-600 font-30 text-blue"><?=$data['prenom'];?></div>
                        </h4>
                        <p class="font-18 max-width-600">
                            Bienvenue dans votre espace sur notre site dédié à l'ENSAH ! <br>

                            En tant que professeur, vous avez accès à une gestion centralisée et efficace de vos tâches académiques. Saisissez les notes, consultez votre emploi du temps, et suivez les performances académiques de vos étudiants. Notre plateforme est conçue pour simplifier votre parcours académique.<br>

                            N'hésitez pas à nous contacter pour toute question ou suggestion. Bienvenue et bonne exploration !
                        </p>
                    </div>
                </div>
            </div>
