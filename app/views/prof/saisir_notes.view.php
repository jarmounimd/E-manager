    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            ...
            <div class="pd-20 card-box mb-30">
                <div class="clearfix">
                    <div class="pull-left">
                        <!-- Supprimé : <h4 class="text-blue h4">Ajouter un module</h4> -->
                        <!-- Supprimé : <p class="mb-30">Entrer les détails de professeur ci-dessous :</p> -->
                    </div>
                </div>
                ...
                <form method="GET" action="acceder_saisir_note">
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                <label>Module</label>
                <select class="custom-select2 form-control" name="id_module" style="width: 100%; height: 38px">
                    <?php foreach ($modules as $module): ?>
                        <option value="<?= htmlspecialchars($module->id_module) ?>"><?= htmlspecialchars($module->nom_module) ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
        </div>
    </div>
    <input type="hidden" name="id_departement" value="<?= htmlspecialchars($_SESSION['user']->id_departement) ?>">
    <input type="hidden" name="id_filiere" value="<?= htmlspecialchars($modules[0]->id_filiere) ?>">
    <button type="submit" class="btn btn-primary">Accéder à saisir les notes</button>
</form>
